...
$(document).on("click", "#checkbox-all", function() {
    ...
    if (_isChecked === false) {
        $(".mdl-data-table").find('tr').addClass("is-selected");
        $(".mdl-data-table").find('tr td label').addClass("is-checked");
    } else {
        $(".mdl-data-table").find('tr').removeClass("is-selected");
        $(".mdl-data-table").find('tr td label').removeClass("is-checked");
    }
...
dialog.querySelector('.remove').addEventListener('click', function() {
    $(".mdl-data-table tbody").find('tr.is-selected').remove();
    $(".mdl-data-table thead tr").removeClass("is-selected");
    $(".mdl-data-table thead tr th label").removeClass("is-checked");
    componentHandler.upgradeDom();
    var _row = $(".mdl-data-table tbody").find('tr');
